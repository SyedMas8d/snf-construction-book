...
// ISO 3166-1 alpha-2 + E.164 calling codes. India first since it's the default;
...
// Unicode regional-indicator flag emoji, computed from the ISO2 code — no image assets needed.
